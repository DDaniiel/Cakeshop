...
if ( ! function_exists( 'metrostore_footer_widget_area' ) ) {
	function metrostore_footer_widget_area(){ 
		if(is_active_sidebar('footer_one') || is_active_sidebar('footer_two') || is_active_sidebar('footer_three') || is_active_sidebar('footer_four') || is_active_sidebar('footer_five')):
		?>
			...
			<div class="social col-sm-6 col-xs-12">
				<ul class="inline-mode">
	                ...
	                <?php if (esc_url(get_theme_mod('metrostore_social_instagram'))) { ?>
	                    <li class="social-network instagram"> <a title="<?php echo esc_attr__('Connect us on Instagram', 'metrostore'); ?>" href="<?php echo esc_url( get_theme_mod('metrostore_social_instagram') ) ; ?>" <?php if ( esc_attr( get_theme_mod('metrostore_social_instagram_checkbox', 0 ) ) == 1) { echo "target=_blank"; } ?>><i class="fa fa-instagram"></i></a> </li>
	                <?php } ?>
